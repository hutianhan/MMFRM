...
class DenseNet(nn.Module):
    def __init__(self, nblocks, growth_rate, reduction, num_classes):
        ...
        # self.fc = nn.Linear(num_planes, num_classes)  # new fc layer 512x7
        # self.alpha = nn.Sequential(nn.Linear(num_planes, 1), nn.Sigmoid())
...
def DenseNet121():
    # return DenseNet([6, 12, 24, 16], growth_rate=32, reduction=0.5, num_classes=7)
    return DenseNet([4, 4, 8, 8], growth_rate=32, reduction=0.5, num_classes=7)
def DenseNet169():
